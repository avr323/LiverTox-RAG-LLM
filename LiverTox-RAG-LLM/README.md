...
- **Hallucination-free DILI information retrieval**
- **Section-aware prioritization** for clinical relevance
- **Multi-LLM support** (GPT-4, Claude, Gemini, Llama)
- **BioBERT embeddings** for medical text understanding
